// ignore_for_file: overridden_fields, annotate_overrides, prefer_initializing_formals
...
class MultiSelectDialogField<V> extends FormField<List<V>> {
  ...
  final TextStyle? chipShowTextStyle;
    ...
    this.key,
            ...
            builder: (FormFieldState<List<V>> state) {
              _MultiSelectDialogFieldView<V> field =
                ...
                chipShowTextStyle: chipShowTextStyle,
                title: title,
                items: items,
...
class _MultiSelectDialogFieldView<V> extends StatefulWidget {
  ...
  _MultiSelectDialogFieldView._withState(
      ...
      : items = field.items,
        title = field.title,
        isMultipleSelection = field.isMultipleSelection,
        chipShowTextStyle = field.chipShowTextStyle,
    ...
    if (widget.chipDisplay != null) {
      ...
      if (widget.chipDisplay!.disabled!) {
        ...
        return MultiSelectChipDisplay<V>(
          ...
          textStyle: widget.chipShowTextStyle,
